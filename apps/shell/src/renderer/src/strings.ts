...
export const strings = {
  zh: {
    ...
    openWithManuscriber: '用 Manuscriber 打开',
    copyPath: '复制路径',
    moveToProject: '移动到项目',
    rename: '重命名',
    duplicate: '创建副本',
    ...
    intgHeroTitle: '在 AI 助手里使用 Manuscriber',
    intgHeroDesc:
      '安装一次 Manuscriber skill，Claude Code、Codex、Cursor 等助手就能替你创建、转换、读取和编辑 Word、Excel、PowerPoint、PDF 和 Markdown 文件。全部在本机完成，不会上传任何内容。',
    ...
    intgStep1Update: 'Manuscriber 升级带来新版 skill 时，对应助手旁会出现「更新」按钮。',
    ...
    intgOtherFolderDesc: '选择它的 skills 目录，Manuscriber 把文件写进去。',
    ...
    intgExample3: '把 budget.xlsx 转成 PDF，并在 Manuscriber 里打开',
    ...
    intgCopied: '已复制',
    intgCliEphemeral: '请先把 Manuscriber 拖到「应用程序」，再使用命令行。',
    intgCopyPath: '复制路径',
    intgCliNeedsUpdate: '此 skill 需要命令行 {v} 或更新版本，请更新 Manuscriber。',
    intgLoading: '正在检测…',
    ...
    starPromptTitle: '喜欢 Manuscriber 吗？',
    starPromptTitleN: '你已经用 Manuscriber 打开了 {n} 个文档',
    starPromptBody: 'Manuscriber 是免费开源软件。到 GitHub 给我们一个 Star，是对团队最好的支持。',
    starPromptGo: '去点 Star',
    starPromptDone: '已经点过了',
    starPromptLater: '以后再说',
    onbStarHint: '如果你喜欢 Manuscriber，欢迎到 GitHub 给我们一个 Star。',
    setEmail: '邮箱',
    setNotLoggedIn: '未登录',
    setViewUsage: '查看用量',
    setChange: '更改',
    ...
    onbTitle1: '欢迎使用 Manuscriber',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
        onbTitleManus: "全新功能：手稿转录器（Manuscriber）",
    onbSubtitleManus: "双栏分屏视图，边查看 PDF / 历史古籍手稿边转录为 Word 文档",
    onbBodyManus: "配备专业转录工作流、智能 AI 提示词库、多语言离线拼写检查与 .manus 项目格式。",
    onbManusFeat1Title: "分屏对照查看",
    onbManusFeat1Desc: "左侧浏览 PDF 原稿，右侧实时编辑 Word 文档",
    onbManusFeat2Title: "专用 AI 提示词",
    onbManusFeat2Desc: "一键提取文字、古籍润色与排版整理",
    onbManusFeat3Title: "三语离线拼写检查",
    onbManusFeat3Desc: "印尼语、阿拉伯语、英语多语言自动校对",
    onbManusFeat4Title: ".manus 项目保存",
    onbManusFeat4Desc: "手稿与文档完整打包，随时随地恢复工作",
onbTitle2: '这只是一个开始',
    onbBody2: 'Manuscriber 目前处于 alpha 阶段。欢迎加入 GenTeam 群聊，分享反馈，一起塑造它的未来。',
  ...
  en: {
    ...
    openWithManuscriber: 'Open with Manuscriber',
    copyPath: 'Copy path',
    ...
    intgHeroTitle: 'Use Manuscriber from your AI assistant',
    intgHeroDesc:
      'Install the Manuscriber skill once, and Claude Code, Codex, Cursor and similar assistants can create, convert, read and edit Word, Excel, PowerPoint, PDF and Markdown files for you. Everything runs on this computer; nothing is uploaded.',
    ...
    intgStep1Update:
      'When a Manuscriber update ships a newer skill, an Update button appears next to that assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pick its skills folder and Manuscriber writes the file there.',
    ...
    intgExample3: 'Convert budget.xlsx to PDF and open it in Manuscriber',
    intgStep2Note:
    ...
    intgCopied: 'Copied',
    intgCliEphemeral: 'Drag Manuscriber into Applications first, then use the command line.',
    intgCopyPath: 'Copy path',
    intgCliNeedsUpdate: 'This skill needs command line {v} or newer; update Manuscriber.',
    ...
    starPromptTitle: 'Enjoying Manuscriber?',
    starPromptTitleN: "You've opened {n} documents with Manuscriber",
    starPromptBody:
      'Manuscriber is free and open source. A star on GitHub is the best way to support the team.',
    starPromptGo: 'Star on GitHub',
    starPromptDone: 'Already starred',
    starPromptLater: 'Maybe later',
    onbStarHint: 'If you like Manuscriber, give us a star on GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'New tab',
    // First-run onboarding
    onbTitle1: 'Welcome to Manuscriber',
    ...
    onbBody1:
      'Create docs, build sheets, make slides, and review PDFs. AI is built into every step.',
        onbTitleManus: "New Feature: Manuscript Transcriber",
    onbSubtitleManus: "Split-screen view to transcribe manuscripts & PDFs directly into Word",
    onbBodyManus: "Featuring dedicated transcription workflow, smart AI prompt presets, offline 3-language spellcheck, and .manus project format.",
    onbManusFeat1Title: "Split-Screen Workspace",
    onbManusFeat1Desc: "Read original PDF on the left, transcribe in Word on the right",
    onbManusFeat2Title: "AI Transcription Prompts",
    onbManusFeat2Desc: "One-click manuscript parsing, polish & formatting",
    onbManusFeat3Title: "Offline 3-Language Spellcheck",
    onbManusFeat3Desc: "Simultaneous check for Indonesian, Arabic, and English",
    onbManusFeat4Title: ".manus Project Format",
    onbManusFeat4Desc: "Keep PDF and document perfectly synced in one project",
onbTitle2: 'This is just the beginning',
    onbBody2:
      'Manuscriber is still in alpha. Join the group chat on GenTeam to share feedback and help shape what comes next.',
  ...
  ja: {
    ...
    openWithManuscriber: 'Manuscriber で開く',
    copyPath: 'パスをコピー',
    ...
    intgHeroTitle: 'AI アシスタントから Manuscriber を使う',
    intgHeroDesc:
      'Manuscriber スキルを一度インストールすると、Claude Code、Codex、Cursor などのアシスタントが Word、Excel、PowerPoint、PDF、Markdown ファイルの作成・変換・読み取り・編集を代行できます。すべてこのパソコン上で完結し、何もアップロードされません。',
    ...
    intgStep1Update:
      'Manuscriber の更新で新しいスキルが届くと、そのアシスタントの横に「更新」ボタンが表示されます。',
    ...
    intgOtherFolderDesc: 'その skills フォルダーを選ぶと、Manuscriber がファイルを書き込みます。',
    ...
    intgExample3: 'budget.xlsx を PDF に変換して Manuscriber で開いて',
    intgStep2Note:
    ...
    intgCopied: 'コピーしました',
    intgCliEphemeral:
      '先に Manuscriber を「アプリケーション」に移してから、コマンドラインを使ってください。',
    intgCopyPath: 'パスをコピー',
    intgCliNeedsUpdate:
      'このスキルにはコマンドライン {v} 以降が必要です。Manuscriber を更新してください。',
    intgLoading: '確認中…',
    ...
    starPromptTitle: 'Manuscriber はいかがですか？',
    starPromptTitleN: 'Manuscriber で {n} 件のドキュメントを開きました',
    starPromptBody:
      'Manuscriber は無料のオープンソースソフトウェアです。GitHub のスターがチームへの何よりの応援になります。',
    starPromptGo: 'スターを付ける',
    starPromptDone: 'スター済み',
    starPromptLater: 'あとで',
    onbStarHint: 'Manuscriber が気に入ったら、GitHub でスターをお願いします。',
    setEmail: 'メール',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'Manuscriber へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
        onbTitleManus: "新機能：写本トランスクライバー（Manuscriber）",
    onbSubtitleManus: "PDFや古文書を閲覧しながらWord文書へ直接転記できる分割画面ビュー",
    onbBodyManus: "専用の文字起こしワークフロー、AIプロンプト、オフライン3言語スペルチェック、.manus形式を搭載。",
    onbManusFeat1Title: "分割画面ワークスペース",
    onbManusFeat1Desc: "左側でPDF原本を閲覧し、右側のWordで文字起こし",
    onbManusFeat2Title: "AI転記プロンプト",
    onbManusFeat2Desc: "ワンクリックでテキスト抽出・校正・レイアウト整理",
    onbManusFeat3Title: "3言語オフラインスペルチェック",
    onbManusFeat3Desc: "インドネシア語・アラビア語・英語を同時チェック",
    onbManusFeat4Title: ".manus プロジェクト形式",
    onbManusFeat4Desc: "PDFと文書を完全に同期して保存・再開",
onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'Manuscriber はまだアルファ版です。GenTeam のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
  ...
  ko: {
    ...
    openWithManuscriber: 'Manuscriber로 열기',
    copyPath: '경로 복사',
    ...
    intgHeroTitle: 'AI 어시스턴트에서 Manuscriber 사용하기',
    intgHeroDesc:
      'Manuscriber 스킬을 한 번 설치하면 Claude Code, Codex, Cursor 같은 어시스턴트가 Word, Excel, PowerPoint, PDF, Markdown 파일을 대신 만들고, 변환하고, 읽고, 편집합니다. 모두 이 컴퓨터 안에서 처리되며 아무것도 업로드되지 않습니다.',
    ...
    intgStep1Update:
      'Manuscriber 업데이트에 새 스킬이 포함되면 해당 어시스턴트 옆에 업데이트 버튼이 나타납니다.',
    ...
    intgOtherFolderDesc: '해당 skills 폴더를 선택하면 Manuscriber가 파일을 기록합니다.',
    ...
    intgExample3: 'budget.xlsx를 PDF로 변환해서 Manuscriber에서 열어 줘',
    intgStep2Note:
    ...
    intgCopied: '복사됨',
    intgCliEphemeral: '먼저 Manuscriber를 응용 프로그램 폴더로 옮긴 뒤 명령줄을 사용하세요.',
    intgCopyPath: '경로 복사',
    intgCliNeedsUpdate: '이 스킬은 명령줄 {v} 이상이 필요합니다. Manuscriber를 업데이트하세요.',
    intgLoading: '확인 중…',
    ...
    starPromptTitle: 'Manuscriber가 마음에 드시나요?',
    starPromptTitleN: 'Manuscriber로 문서를 {n}개 열어보셨네요',
    starPromptBody:
      'Manuscriber는 무료 오픈 소스 소프트웨어입니다. GitHub 스타 하나가 팀에게 가장 큰 응원이 됩니다.',
    starPromptGo: '스타 누르기',
    starPromptDone: '이미 눌렀어요',
    starPromptLater: '나중에',
    onbStarHint: 'Manuscriber가 마음에 들면 GitHub에서 스타를 눌러 주세요.',
    setEmail: '이메일',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'Manuscriber에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
        onbTitleManus: "새로운 기능: 원고 전사기 (Manuscriber)",
    onbSubtitleManus: "PDF 및 고문서 원본을 보면서 Word 문서로 바로 전사하는 분할 화면 뷰",
    onbBodyManus: "전용 전사 워크플로, 맞춤형 AI 프롬프트, 오프라인 3개 국어 맞춤법 검사 및 .manus 프로젝트 형식을 지원합니다.",
    onbManusFeat1Title: "분할 화면 작업 공간",
    onbManusFeat1Desc: "왼쪽에서 PDF 원본을 보고, 오른쪽 Word에서 바로 전사",
    onbManusFeat2Title: "AI 전사 프롬프트",
    onbManusFeat2Desc: "원클릭 텍스트 추출, 교정 및 서식 정리",
    onbManusFeat3Title: "오프라인 3개 국어 맞춤법 검사",
    onbManusFeat3Desc: "인도네시아어, 아랍어, 영어 동시 자동 검사",
    onbManusFeat4Title: ".manus 프로젝트 형식",
    onbManusFeat4Desc: "PDF와 문서를 완벽하게 동기화하여 프로젝트로 저장",
onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'Manuscriber는 아직 알파 단계입니다. GenTeam 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
  ...
  fr: {
    ...
    openWithManuscriber: 'Ouvrir avec Manuscriber',
    ...
    intgHeroTitle: 'Utiliser Manuscriber depuis votre assistant IA',
    intgHeroDesc:
      "Installez le skill Manuscriber une fois, et Claude Code, Codex, Cursor et les assistants similaires pourront créer, convertir, lire et modifier des fichiers Word, Excel, PowerPoint, PDF et Markdown pour vous. Tout s'exécute sur cet ordinateur ; rien n'est envoyé.",
    ...
    intgStep1Update:
      'Quand une mise à jour de Manuscriber apporte un skill plus récent, un bouton Mettre à jour apparaît à côté de cet assistant.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Choisissez son dossier skills et Manuscriber y écrit le fichier.',
    ...
    intgExample3: 'Convertis budget.xlsx en PDF et ouvre-le dans Manuscriber',
    intgStep2Note:
    ...
    intgCopied: 'Copié',
    intgCliEphemeral:
      "Glissez d'abord Manuscriber dans Applications, puis utilisez la ligne de commande.",
    intgCopyPath: 'Copier le chemin',
    intgCliNeedsUpdate:
      'Ce skill requiert la ligne de commande {v} ou plus récente ; mettez Manuscriber à jour.',
    ...
    starPromptTitle: 'Manuscriber vous plaît ?',
    starPromptTitleN: 'Vous avez ouvert {n} documents avec Manuscriber',
    starPromptBody:
      'Manuscriber est gratuit et open source. Une étoile sur GitHub est le meilleur moyen de soutenir l’équipe.',
    starPromptGo: 'Mettre une étoile',
    starPromptDone: 'Déjà fait',
    starPromptLater: 'Plus tard',
    onbStarHint: 'Si Manuscriber vous plaît, mettez-nous une étoile sur GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans Manuscriber',
    ...
    onbBody1:
      'Créez des documents, des feuilles de calcul et des présentations, et relisez des PDF. L’IA est intégrée à chaque étape.',
        onbTitleManus: "Nouvelle fonctionnalité : Transcripteur de manuscrits",
    onbSubtitleManus: "Affichage fractionné pour transcrire manuscrits et PDF directement dans Word",
    onbBodyManus: "Avec flux de transcription dédié, invites IA intelligentes, vérification orthographique hors ligne en 3 langues et format de projet .manus.",
    onbManusFeat1Title: "Espace fractionné",
    onbManusFeat1Desc: "Consultez le PDF original à gauche, transcrivez dans Word à droite",
    onbManusFeat2Title: "Invites IA de transcription",
    onbManusFeat2Desc: "Extraction de texte, correction et mise en page en un clic",
    onbManusFeat3Title: "Orthographe 3 langues hors ligne",
    onbManusFeat3Desc: "Contrôle simultané en indonésien, arabe et anglais",
    onbManusFeat4Title: "Format de projet .manus",
    onbManusFeat4Desc: "PDF et document synchronisés dans un seul projet",
onbTitle2: 'Ce n’est qu’un début',
    onbBody2:
      'Manuscriber est encore en alpha. Rejoignez la discussion de groupe sur GenTeam pour partager vos retours et façonner la suite.',
  ...
  de: {
    ...
    openWithManuscriber: 'Mit Manuscriber öffnen',
    ...
    intgHeroTitle: 'Manuscriber aus Ihrem KI-Assistenten nutzen',
    intgHeroDesc:
      'Installieren Sie den Manuscriber-Skill einmal, und Claude Code, Codex, Cursor und ähnliche Assistenten können Word-, Excel-, PowerPoint-, PDF- und Markdown-Dateien für Sie erstellen, konvertieren, lesen und bearbeiten. Alles läuft auf diesem Rechner; nichts wird hochgeladen.',
    ...
    intgStep1Update:
      'Bringt ein Manuscriber-Update einen neueren Skill mit, erscheint neben diesem Assistenten ein Aktualisieren-Button.',
    intgSkillVersion: 'Skill {v}',
    ...
    intgOtherFolderDesc:
      'Wählen Sie seinen Skills-Ordner, und Manuscriber schreibt die Datei dorthin.',
    ...
    intgExample3: 'Wandle budget.xlsx in PDF um und öffne es in Manuscriber',
    intgStep2Note:
    ...
    intgCopied: 'Kopiert',
    intgCliEphemeral:
      'Ziehen Sie Manuscriber zuerst in „Programme“, dann nutzen Sie die Befehlszeile.',
    intgCopyPath: 'Pfad kopieren',
    intgCliNeedsUpdate:
      'Dieser Skill braucht Befehlszeile {v} oder neuer; aktualisieren Sie Manuscriber.',
    intgLoading: 'Prüfe …',
    ...
    starPromptTitle: 'Gefällt Ihnen Manuscriber?',
    starPromptTitleN: 'Sie haben {n} Dokumente mit Manuscriber geöffnet',
    starPromptBody:
      'Manuscriber ist kostenlos und Open Source. Ein Stern auf GitHub ist die beste Unterstützung für das Team.',
    starPromptGo: 'Stern geben',
    starPromptDone: 'Schon erledigt',
    starPromptLater: 'Später',
    onbStarHint: 'Wenn Ihnen Manuscriber gefällt, geben Sie uns einen Stern auf GitHub.',
    setEmail: 'E-Mail',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei Manuscriber',
    ...
    onbBody1:
      'Dokumente erstellen, Tabellen bauen, Präsentationen gestalten und PDFs prüfen. KI ist in jedem Schritt integriert.',
        onbTitleManus: "Neues Feature: Manuskript-Transkribierer",
    onbSubtitleManus: "Geteilte Ansicht zur Transkription von Manuskripten und PDFs direkt in Word",
    onbBodyManus: "Mit speziellem Transkriptions-Workflow, KI-Prompt-Vorlagen, Offline-Rechtschreibprüfung für 3 Sprachen und .manus-Projektformat.",
    onbManusFeat1Title: "Geteilter Arbeitsbereich",
    onbManusFeat1Desc: "Original-PDF links ansehen, rechts in Word transkribieren",
    onbManusFeat2Title: "KI-Transkriptions-Prompts",
    onbManusFeat2Desc: "Textextraktion, Korrektur und Formatierung mit einem Klick",
    onbManusFeat3Title: "Offline 3-Sprachen-Korrektur",
    onbManusFeat3Desc: "Gleichzeitige Prüfung für Indonesisch, Arabisch und Englisch",
    onbManusFeat4Title: ".manus-Projektformat",
    onbManusFeat4Desc: "PDF und Dokument nahtlos in einem Projekt gebündelt",
onbTitle2: 'Das ist erst der Anfang',
    onbBody2:
      'Manuscriber ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf GenTeam bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
  ...
  es: {
    ...
    openWithManuscriber: 'Abrir con Manuscriber',
    ...
    intgHeroTitle: 'Usa Manuscriber desde tu asistente de IA',
    intgHeroDesc:
      'Instala el skill de Manuscriber una vez y Claude Code, Codex, Cursor y asistentes similares podrán crear, convertir, leer y editar archivos de Word, Excel, PowerPoint, PDF y Markdown por ti. Todo se ejecuta en este equipo; no se sube nada.',
    ...
    intgStep1Update:
      'Cuando una actualización de Manuscriber traiga un skill más nuevo, aparecerá un botón Actualizar junto a ese asistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Elige su carpeta de skills y Manuscriber escribe el archivo ahí.',
    ...
    intgExample3: 'Convierte budget.xlsx a PDF y ábrelo en Manuscriber',
    intgStep2Note:
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral: 'Arrastra primero Manuscriber a Aplicaciones y luego usa la línea de comandos.',
    intgCopyPath: 'Copiar ruta',
    intgCliNeedsUpdate:
      'Este skill necesita la línea de comandos {v} o superior; actualiza Manuscriber.',
    ...
    starPromptTitle: '¿Te gusta Manuscriber?',
    starPromptTitleN: 'Has abierto {n} documentos con Manuscriber',
    starPromptBody:
      'Manuscriber es gratuito y de código abierto. Una estrella en GitHub es la mejor forma de apoyar al equipo.',
    starPromptGo: 'Dar una estrella',
    starPromptDone: 'Ya la di',
    starPromptLater: 'Más tarde',
    onbStarHint: 'Si te gusta Manuscriber, danos una estrella en GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a Manuscriber',
    ...
    onbBody1:
      'Crea documentos, hojas de cálculo y presentaciones, y revisa PDF. La IA está integrada en cada paso.',
        onbTitleManus: "Nueva función: Transcriptor de manuscritos",
    onbSubtitleManus: "Vista dividida para transcribir manuscritos y PDF directamente en Word",
    onbBodyManus: "Con flujo de trabajo dedicado, prompts de IA especializados, corrector ortográfico sin conexión en 3 idiomas y formato .manus.",
    onbManusFeat1Title: "Espacio de trabajo dividido",
    onbManusFeat1Desc: "Lea el PDF original a la izquierda y transcriba en Word a la derecha",
    onbManusFeat2Title: "Prompts de IA para transcripción",
    onbManusFeat2Desc: "Extracción de texto, pulido y formateo en un solo clic",
    onbManusFeat3Title: "Corrector en 3 idiomas sin conexión",
    onbManusFeat3Desc: "Revisión simultánea en indonesio, árabe e inglés",
    onbManusFeat4Title: "Formato de proyecto .manus",
    onbManusFeat4Desc: "PDF y documento sincronizados en un único proyecto",
onbTitle2: 'Esto es solo el comienzo',
    onbBody2:
      'Manuscriber aún está en alfa. Únete al chat grupal en GenTeam para compartir comentarios y ayudar a dar forma a lo que viene.',
  ...
  th: {
    ...
    openWithManuscriber: 'เปิดด้วย Manuscriber',
    ...
    intgHeroTitle: 'ใช้ Manuscriber จากผู้ช่วย AI ของคุณ',
    intgHeroDesc:
      'ติดตั้งสกิล Manuscriber เพียงครั้งเดียว Claude Code, Codex, Cursor และผู้ช่วยลักษณะเดียวกันจะสร้าง แปลง อ่าน และแก้ไขไฟล์ Word, Excel, PowerPoint, PDF และ Markdown ให้คุณได้ ทุกอย่างทำงานบนคอมพิวเตอร์เครื่องนี้ ไม่มีการอัปโหลดใด ๆ',
    ...
    intgStep1Update:
      'เมื่อการอัปเดต Manuscriber มาพร้อมสกิลเวอร์ชันใหม่ ปุ่มอัปเดตจะปรากฏข้างผู้ช่วยนั้น',
    ...
    intgOtherFolderDesc: 'เลือกโฟลเดอร์ skills ของผู้ช่วย แล้ว Manuscriber จะเขียนไฟล์ลงไป',
    ...
    intgExample3: 'แปลง budget.xlsx เป็น PDF แล้วเปิดใน Manuscriber',
    ...
    intgCliEphemeral: 'กรุณาลาก Manuscriber ไปที่ Applications ก่อน แล้วจึงใช้บรรทัดคำสั่ง',
    intgCopyPath: 'คัดลอกพาธ',
    intgCliNeedsUpdate: 'สกิลนี้ต้องใช้บรรทัดคำสั่ง {v} หรือใหม่กว่า โปรดอัปเดต Manuscriber',
    ...
    starPromptTitle: 'ชอบ Manuscriber ไหม?',
    starPromptTitleN: 'คุณเปิดเอกสารด้วย Manuscriber ไปแล้ว {n} ไฟล์',
    starPromptBody:
      'Manuscriber ฟรีและเป็นโอเพนซอร์ส การกดดาวบน GitHub คือกำลังใจที่ดีที่สุดสำหรับทีม',
    starPromptGo: 'กดดาวเลย',
    starPromptDone: 'กดแล้ว',
    starPromptLater: 'ไว้ทีหลัง',
    onbStarHint: 'ถ้าชอบ Manuscriber ฝากกดดาวให้เราบน GitHub ด้วยนะ',
    setEmail: 'อีเมล',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ Manuscriber',
    ...
    onbBody1: 'สร้างเอกสาร ทำสเปรดชีต สร้างงานนำเสนอ และตรวจทาน PDF ทุกขั้นตอนมี AI ในตัว',
        onbTitleManus: "ฟีเจอร์ใหม่: เครื่องมือถอดความต้นฉบับ (Manuscriber)",
    onbSubtitleManus: "มุมมองแยกหน้าจอเพื่อถอดความต้นฉบับและ PDF ลงในเอกสาร Word โดยตรง",
    onbBodyManus: "มาพร้อมเวิร์กโฟลว์ถอดความเฉพาะ พรอมต์ AI อัจฉริยะ ตรวจสะกด 3 ภาษาแบบออฟไลน์ และรูปแบบโปรเจกต์ .manus",
    onbManusFeat1Title: "พื้นที่ทำงานแยกหน้าจอ",
    onbManusFeat1Desc: "ดูเอกสาร PDF ต้นฉบับทางซ้าย ถอดความใน Word ทางขวา",
    onbManusFeat2Title: "พรอมต์ AI สำหรับถอดความ",
    onbManusFeat2Desc: "สกัดข้อความ ปรับปรุงสำนวน และจัดรูปแบบในคลิกเดียว",
    onbManusFeat3Title: "ตรวจตัวสะกด 3 ภาษาออฟไลน์",
    onbManusFeat3Desc: "ตรวจสอบภาษาอินโดนีเซีย อาหรับ และอังกฤษพร้อมกัน",
    onbManusFeat4Title: "รูปแบบโปรเจกต์ .manus",
    onbManusFeat4Desc: "บันทึก PDF และเอกสารทำงานรวมกันในไฟล์เดียว",
onbTitle2: 'นี่เป็นเพียงจุดเริ่มต้น',
    onbBody2:
      'Manuscriber ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน GenTeam เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
  ...
  id: {
    ...
    openWithManuscriber: 'Buka dengan Manuscriber',
    ...
    intgHeroTitle: 'Gunakan Manuscriber dari asisten AI Anda',
    intgHeroDesc:
      'Pasang skill Manuscriber sekali, dan Claude Code, Codex, Cursor, serta asisten serupa dapat membuat, mengonversi, membaca, dan mengedit file Word, Excel, PowerPoint, PDF, dan Markdown untuk Anda. Semuanya berjalan di komputer ini; tidak ada yang diunggah.',
    ...
    intgStep1Update:
      'Saat pembaruan Manuscriber membawa skill yang lebih baru, tombol Perbarui muncul di samping asisten itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills-nya dan Manuscriber menulis file di sana.',
    ...
    intgExample3: 'Konversi budget.xlsx ke PDF dan buka di Manuscriber',
    intgStep2Note:
    ...
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret Manuscriber ke Applications dulu, lalu gunakan baris perintah.',
    intgCopyPath: 'Salin path',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris perintah {v} atau lebih baru; perbarui Manuscriber.',
    ...
    starPromptTitle: 'Suka Manuscriber?',
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Manuscriber',
    starPromptBody:
      'Manuscriber gratis dan open source. Bintang di GitHub adalah dukungan terbaik untuk tim kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Nanti saja',
    onbStarHint: 'Jika Anda menyukai Manuscriber, beri kami bintang di GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di Manuscriber',
    ...
    onbBody1:
      'Buat dokumen, susun spreadsheet, rancang presentasi, dan tinjau PDF. AI hadir di setiap langkah.',
        onbTitleManus: "Fitur Baru: Manuscriber (Transkripsi Naskah & PDF)",
    onbSubtitleManus: "Tampilan split-screen untuk mentranskripsi naskah dan dokumen PDF langsung ke Word",
    onbBodyManus: "Dilengkapi viewer PDF terintegrasi, pintasan prompt AI khusus transkripsi, cek ejaan 3 bahasa otomatis offline, dan format proyek .manus.",
    onbManusFeat1Title: "Ruang Kerja Split-Screen",
    onbManusFeat1Desc: "Baca PDF naskah di sisi kiri, ketik transkrip di Word di sisi kanan",
    onbManusFeat2Title: "Pintasan Prompt AI Khusus",
    onbManusFeat2Desc: "Ringkasan, koreksi ejaan kuno, dan pemformatan instan",
    onbManusFeat3Title: "Cek Ejaan 3 Bahasa Offline",
    onbManusFeat3Desc: "Pemeriksaan ejaan otomatis Indonesia, Arab, dan Inggris simultan",
    onbManusFeat4Title: "Format Proyek .manus",
    onbManusFeat4Desc: "Simpan PDF dan dokumen kerja tersinkronisasi dalam satu file",
onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Manuscriber masih dalam tahap alpha. Gabung obrolan grup di GenTeam untuk berbagi masukan dan ikut menentukan arah ke depan.',
  ...
  ru: {
    ...
    openWithManuscriber: 'Открыть в Manuscriber',
    ...
    intgHeroTitle: 'Используйте Manuscriber из своего ИИ-ассистента',
    intgHeroDesc:
      'Установите скилл Manuscriber один раз, и Claude Code, Codex, Cursor и похожие ассистенты смогут создавать, конвертировать, читать и редактировать файлы Word, Excel, PowerPoint, PDF и Markdown за вас. Всё выполняется на этом компьютере; ничего не отправляется.',
    ...
    intgStep1Update:
      'Когда обновление Manuscriber принесёт более новый скилл, рядом с этим ассистентом появится кнопка «Обновить».',
    ...
    intgOtherFolderDesc: 'Выберите его папку skills, и Manuscriber запишет файл туда.',
    ...
    intgExample3: 'Конвертируй budget.xlsx в PDF и открой в Manuscriber',
    intgStep2Note:
    ...
    intgCliEphemeral:
      'Сначала перетащите Manuscriber в «Программы», затем используйте командную строку.',
    intgCopyPath: 'Копировать путь',
    intgCliNeedsUpdate: 'Этому скиллу нужна командная строка {v} или новее; обновите Manuscriber.',
    ...
    starPromptTitle: 'Нравится Manuscriber?',
    starPromptTitleN: 'Вы уже открыли {n} документов в Manuscriber',
    starPromptBody:
      'Manuscriber — бесплатное ПО с открытым кодом. Звезда на GitHub — лучшая поддержка для команды.',
    starPromptGo: 'Поставить звезду',
    starPromptDone: 'Уже поставлена',
    starPromptLater: 'Позже',
    onbStarHint: 'Если вам нравится Manuscriber, поставьте нам звезду на GitHub.',
    setEmail: 'Эл. почта',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в Manuscriber',
    ...
    onbBody1:
      'Создавайте документы, таблицы и презентации, работайте с PDF. ИИ встроен в каждый шаг.',
        onbTitleManus: "Новая функция: Транскрибатор рукописей (Manuscriber)",
    onbSubtitleManus: "Разделенный экран для расшифровки рукописей и PDF прямо в документ Word",
    onbBodyManus: "Включает специализированный рабочий процесс, промпты ИИ, офлайн-проверку орфографии на 3 языках и формат проекта .manus.",
    onbManusFeat1Title: "Разделенный экран",
    onbManusFeat1Desc: "Просматривайте PDF слева, набирайте текст в Word справа",
    onbManusFeat2Title: "Промпты ИИ для расшифровки",
    onbManusFeat2Desc: "Распознавание текста, стилистическая правка и форматирование",
    onbManusFeat3Title: "Офлайн-проверка на 3 языках",
    onbManusFeat3Desc: "Одновременная проверка индонезийского, арабского и английского",
    onbManusFeat4Title: "Формат проекта .manus",
    onbManusFeat4Desc: "PDF и документ синхронизированы в одном проекте",
onbTitle2: 'Это только начало',
    onbBody2:
      'Manuscriber пока в альфа-версии. Присоединяйтесь к групповому чату в GenTeam, чтобы делиться отзывами и влиять на дальнейшее развитие.',
  ...
  ar: {
    ...
    openWithManuscriber: 'فتح بواسطة Manuscriber',
    copyPath: 'نسخ المسار',
    ...
    intgHeroTitle: 'استخدم Manuscriber من مساعد الذكاء الاصطناعي',
    intgHeroDesc:
      'ثبّت مهارة Manuscriber مرة واحدة، وسيتمكن Claude Code وCodex وCursor والمساعدون المشابهون من إنشاء ملفات Word وExcel وPowerPoint وPDF وMarkdown وتحويلها وقراءتها وتحريرها لك. كل شيء يعمل على هذا الجهاز؛ لا يُرفع أي شيء.',
    ...
    intgStep1Update: 'عندما يجلب تحديث Manuscriber مهارة أحدث، يظهر زر «تحديث» بجوار ذلك المساعد.',
    ...
    intgOtherFolderDesc: 'اختر مجلد skills الخاص به وسيكتب Manuscriber الملف هناك.',
    ...
    intgExample3: 'حوّل budget.xlsx إلى PDF وافتحه في Manuscriber',
    ...
    intgCopied: 'تم النسخ',
    intgCliEphemeral: 'اسحب Manuscriber إلى مجلد التطبيقات أولاً، ثم استخدم سطر الأوامر.',
    intgCopyPath: 'نسخ المسار',
    intgCliNeedsUpdate: 'تحتاج هذه المهارة إلى سطر الأوامر {v} أو أحدث؛ حدّث Manuscriber.',
    ...
    starPromptTitle: 'هل أعجبك Manuscriber؟',
    starPromptTitleN: 'لقد فتحت {n} من المستندات في Manuscriber',
    starPromptBody: 'Manuscriber مجاني ومفتوح المصدر. نجمة على GitHub هي أفضل دعم للفريق.',
    starPromptGo: 'ضع نجمة',
    starPromptDone: 'وضعتها بالفعل',
    starPromptLater: 'لاحقًا',
    onbStarHint: 'إذا أعجبك Manuscriber، ضع لنا نجمة على GitHub.',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في Manuscriber',
    ...
    onbBody1:
      'أنشئ المستندات وجداول البيانات والعروض التقديمية وراجع ملفات PDF. الذكاء الاصطناعي مدمج في كل خطوة.',
        onbTitleManus: "ميزة جديدة: ناسخ المخطوطات (Manuscriber)",
    onbSubtitleManus: "عرض شاشة مقسمة لنسخ المخطوطات وملفات PDF مباشرة إلى مستند Word",
    onbBodyManus: "مجهزة ببيئة عمل متخصصة، موجهات ذكاء اصطناعي ذكية، تدقيق إملائي لـ 3 لغات بدون إنترنت، وتنسيق .manus للمشاريع.",
    onbManusFeat1Title: "مساحة عمل مقسمة",
    onbManusFeat1Desc: "قراءة ملف PDF الأصلي على اليسار والكتابة في Word على اليمين",
    onbManusFeat2Title: "موجهات الذكاء الاصطناعي",
    onbManusFeat2Desc: "استخراج النصوص وتدقيق المخطوطات وتنسيقها بنقرة واحدة",
    onbManusFeat3Title: "تدقيق إملائي ثلاثي دون إنترنت",
    onbManusFeat3Desc: "فحص فوري للغة الإندونيسية والعربية والإنجليزية معاً",
    onbManusFeat4Title: "تنسيق المشروع .manus",
    onbManusFeat4Desc: "حفظ ملف PDF والمستند متزامنين تماماً في مشروع واحد",
onbTitle2: 'هذه مجرد البداية',
    onbBody2:
      'لا يزال Manuscriber في مرحلة ألفا. انضم إلى الدردشة الجماعية على GenTeam لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
  ...
  pt: {
    ...
    openWithManuscriber: 'Abrir com Manuscriber',
    ...
    intgHeroTitle: 'Use o Manuscriber a partir do seu assistente de IA',
    intgHeroDesc:
      'Instale o skill do Manuscriber uma vez e o Claude Code, Codex, Cursor e assistentes semelhantes poderão criar, converter, ler e editar arquivos Word, Excel, PowerPoint, PDF e Markdown para você. Tudo roda neste computador; nada é enviado.',
    ...
    intgStep1Update:
      'Quando uma atualização do Manuscriber trouxer um skill mais novo, um botão Atualizar aparece ao lado desse assistente.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Escolha a pasta de skills dele e o Manuscriber grava o arquivo lá.',
    ...
    intgExample3: 'Converta budget.xlsx para PDF e abra no Manuscriber',
    intgStep2Note:
    ...
    intgCopied: 'Copiado',
    intgCliEphemeral:
      'Arraste o Manuscriber para Aplicativos primeiro e depois use a linha de comando.',
    intgCopyPath: 'Copiar caminho',
    intgCliNeedsUpdate:
      'Este skill precisa da linha de comando {v} ou mais recente; atualize o Manuscriber.',
    ...
    starPromptTitle: 'Gostando do Manuscriber?',
    starPromptTitleN: 'Você já abriu {n} documentos com o Manuscriber',
    starPromptBody:
      'O Manuscriber é gratuito e de código aberto. Uma estrela no GitHub é a melhor forma de apoiar a equipe.',
    starPromptGo: 'Dar uma estrela',
    starPromptDone: 'Já dei',
    starPromptLater: 'Mais tarde',
    onbStarHint: 'Se você gosta do Manuscriber, deixe uma estrela no GitHub.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao Manuscriber',
    ...
    onbBody1:
      'Crie documentos, planilhas e apresentações e revise PDFs. A IA está integrada em cada etapa.',
        onbTitleManus: "Novo recurso: Transcritor de Manuscritos",
    onbSubtitleManus: "Visualização em tela dividida para transcrever manuscritos e PDFs diretamente no Word",
    onbBodyManus: "Com fluxo de transcrição dedicado, prompts de IA inteligentes, corretor ortográfico offline em 3 idiomas e formato de projeto .manus.",
    onbManusFeat1Title: "Área de trabalho dividida",
    onbManusFeat1Desc: "Visualize o PDF original à esquerda e transcreva no Word à direita",
    onbManusFeat2Title: "Prompts de IA para transcrição",
    onbManusFeat2Desc: "Extração de texto, revisão e formatação em um clique",
    onbManusFeat3Title: "Corretor offline em 3 idiomas",
    onbManusFeat3Desc: "Verificação simultânea em indonésio, árabe e inglês",
    onbManusFeat4Title: "Formato de projeto .manus",
    onbManusFeat4Desc: "PDF e documento perfeitamente sincronizados no mesmo projeto",
onbTitle2: 'Isto é só o começo',
    onbBody2:
      'O Manuscriber ainda está em alfa. Entre no chat em grupo no GenTeam para compartilhar feedback e ajudar a moldar o que vem a seguir.',
  ...
  it: {
    ...
    openWithManuscriber: 'Apri con Manuscriber',
    ...
    intgHeroTitle: 'Usa Manuscriber dal tuo assistente IA',
    intgHeroDesc:
      'Installa lo skill Manuscriber una volta e Claude Code, Codex, Cursor e assistenti simili potranno creare, convertire, leggere e modificare file Word, Excel, PowerPoint, PDF e Markdown per te. Tutto avviene su questo computer; nulla viene caricato.',
    ...
    intgStep1Update:
      "Quando un aggiornamento di Manuscriber porta uno skill più recente, accanto a quell'assistente compare un pulsante Aggiorna.",
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Scegli la sua cartella skills e Manuscriber vi scrive il file.',
    ...
    intgExample3: 'Converti budget.xlsx in PDF e aprilo in Manuscriber',
    intgStep2Note:
    ...
    intgCopied: 'Copiato',
    intgCliEphemeral: 'Trascina prima Manuscriber in Applicazioni, poi usa la riga di comando.',
    intgCopyPath: 'Copia percorso',
    intgCliNeedsUpdate:
      'Questo skill richiede la riga di comando {v} o successiva; aggiorna Manuscriber.',
    ...
    starPromptTitle: 'Ti piace Manuscriber?',
    starPromptTitleN: 'Hai aperto {n} documenti con Manuscriber',
    starPromptBody:
      'Manuscriber è gratuito e open source. Una stella su GitHub è il modo migliore per sostenere il team.',
    starPromptGo: 'Metti una stella',
    starPromptDone: 'Già fatto',
    starPromptLater: 'Più tardi',
    onbStarHint: 'Se ti piace Manuscriber, lasciaci una stella su GitHub.',
    setEmail: 'Email',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in Manuscriber',
    ...
    onbBody1:
      'Crea documenti, fogli di calcolo e presentazioni e rivedi i PDF. L’IA è integrata in ogni passaggio.',
        onbTitleManus: "Nuova funzionalità: Trascrittore di manoscritti",
    onbSubtitleManus: "Visualizzazione a schermo diviso per trascrivere manoscritti e PDF direttamente in Word",
    onbBodyManus: "Con flusso di lavoro dedicato, prompt IA intelligenti, correttore ortografico offline in 3 lingue e formato di progetto .manus.",
    onbManusFeat1Title: "Spazio di lavoro diviso",
    onbManusFeat1Desc: "Leggi il PDF originale a sinistra, trascrivi in Word a destra",
    onbManusFeat2Title: "Prompt IA per trascrizione",
    onbManusFeat2Desc: "Estrazione testo, revisione e formattazione con un clic",
    onbManusFeat3Title: "Controllo ortografico in 3 lingue offline",
    onbManusFeat3Desc: "Controllo simultaneo per indonesiano, arabo e inglese",
    onbManusFeat4Title: "Formato di progetto .manus",
    onbManusFeat4Desc: "PDF e documento perfettamente sincronizzati in un solo file",
onbTitle2: 'Questo è solo l’inizio',
    onbBody2:
      'Manuscriber è ancora in alpha. Unisciti alla chat di gruppo su GenTeam per condividere feedback e contribuire a plasmare il futuro.',
  ...
  pl: {
    ...
    openWithManuscriber: 'Otwórz w Manuscriber',
    ...
    intgHeroTitle: 'Używaj Manuscriber ze swojego asystenta AI',
    intgHeroDesc:
      'Zainstaluj skill Manuscriber raz, a Claude Code, Codex, Cursor i podobne asystenty będą tworzyć, konwertować, czytać i edytować pliki Word, Excel, PowerPoint, PDF i Markdown za Ciebie. Wszystko działa na tym komputerze; nic nie jest wysyłane.',
    ...
    intgStep1Update:
      'Gdy aktualizacja Manuscriber przyniesie nowszy skill, obok tego asystenta pojawi się przycisk Aktualizuj.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Wybierz jego folder skills, a Manuscriber zapisze tam plik.',
    ...
    intgExample3: 'Przekonwertuj budget.xlsx do PDF i otwórz w Manuscriber',
    ...
    intgCliEphemeral: 'Najpierw przenieś Manuscriber do Aplikacji, potem użyj wiersza poleceń.',
    intgCopyPath: 'Kopiuj ścieżkę',
    intgCliNeedsUpdate: 'Ten skill wymaga wiersza poleceń {v} lub nowszego; zaktualizuj Manuscriber.',
    ...
    starPromptTitle: 'Podoba Ci się Manuscriber?',
    starPromptTitleN: 'Otwarto już {n} dokumentów w Manuscriber',
    starPromptBody:
      'Manuscriber jest darmowy i open source. Gwiazdka na GitHubie to najlepsze wsparcie dla zespołu.',
    starPromptGo: 'Daj gwiazdkę',
    starPromptDone: 'Już zrobione',
    starPromptLater: 'Później',
    onbStarHint: 'Jeśli podoba Ci się Manuscriber, zostaw nam gwiazdkę na GitHubie.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nowa karta',
    // First-run onboarding
    onbTitle1: 'Witamy w Manuscriber',
    ...
    onbBody1:
      'Twórz dokumenty, arkusze i prezentacje oraz przeglądaj pliki PDF. AI jest wbudowana w każdy etap.',
        onbTitleManus: "Nowa funkcja: Transkrypcja rękopisów (Manuscriber)",
    onbSubtitleManus: "Widok podzielonego ekranu do transkrypcji rękopisów i plików PDF bezpośrednio w programie Word",
    onbBodyManus: "Z dedykowanym przepływem pracy, szablonami poleceń AI, potrójnym sprawdzaniem pisowni offline i formatem projektu .manus.",
    onbManusFeat1Title: "Podzielony obszar roboczy",
    onbManusFeat1Desc: "Przeglądaj oryginalny PDF po lewej, przepisuj w Wordzie po prawej",
    onbManusFeat2Title: "Polecenia AI do transkrypcji",
    onbManusFeat2Desc: "Ekstrakcja tekstu, korekta i formatowanie jednym kliknięciem",
    onbManusFeat3Title: "Pisownia w 3 językach offline",
    onbManusFeat3Desc: "Jednoczesne sprawdzanie języka indonezyjskiego, arabskiego i angielskiego",
    onbManusFeat4Title: "Format projektu .manus",
    onbManusFeat4Desc: "Zsynchronizowany plik PDF i dokument w jednym projekcie",
onbTitle2: 'To dopiero początek',
    onbBody2:
      'Manuscriber jest wciąż w fazie alfa. Dołącz do czatu grupowego na GenTeam, aby dzielić się opiniami i współtworzyć jego przyszłość.',
  ...
  cs: {
    ...
    openWithManuscriber: 'Otevřít v Manuscriber',
    ...
    intgHeroTitle: 'Používejte Manuscriber ze svého AI asistenta',
    intgHeroDesc:
      'Nainstalujte skill Manuscriber jednou a Claude Code, Codex, Cursor a podobní asistenti za vás budou vytvářet, převádět, číst a upravovat soubory Word, Excel, PowerPoint, PDF a Markdown. Vše běží na tomto počítači; nic se neodesílá.',
    ...
    intgStep1Update:
      'Když aktualizace Manuscriber přinese novější skill, u daného asistenta se objeví tlačítko Aktualizovat.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Vyberte jeho složku skills a Manuscriber tam soubor zapíše.',
    ...
    intgExample3: 'Převeď budget.xlsx do PDF a otevři ho v Manuscriber',
    ...
    intgCliEphemeral: 'Nejprve přetáhněte Manuscriber do Aplikací a poté použijte příkazový řádek.',
    intgCopyPath: 'Kopírovat cestu',
    intgCliNeedsUpdate:
      'Tento skill vyžaduje příkazový řádek {v} nebo novější; aktualizujte Manuscriber.',
    ...
    starPromptTitle: 'Líbí se vám Manuscriber?',
    starPromptTitleN: 'V Manuscriber jste otevřeli už {n} dokumentů',
    starPromptBody:
      'Manuscriber je zdarma a open source. Hvězdička na GitHubu je nejlepší způsob, jak tým podpořit.',
    starPromptGo: 'Dát hvězdičku na GitHubu',
    starPromptDone: 'Hvězdička už udělena',
    starPromptLater: 'Možná později',
    onbStarHint: 'Pokud se vám Manuscriber líbí, dejte nám hvězdičku na GitHubu.',
    setEmail: 'E-mail',
    ...
    newTab: 'Nová karta',
    // First-run onboarding
    onbTitle1: 'Vítejte v Manuscriber',
    ...
    onbBody1:
      'Vytvářejte dokumenty, tabulky a prezentace a kontrolujte PDF. AI je součástí každého kroku.',
        onbTitleManus: "Nová funkce: Přepisovač rukopisů (Manuscriber)",
    onbSubtitleManus: "Rozdělené zobrazení pro přepis rukopisů a PDF přímo do dokumentu Word",
    onbBodyManus: "Obsahuje specializovaný pracovní postup, AI výzvy, offline kontrolu pravopisu ve 3 jazycích a formát projektu .manus.",
    onbManusFeat1Title: "Rozdělená pracovní plocha",
    onbManusFeat1Desc: "Prohlížejte původní PDF vlevo, přepisujte ve Wordu vpravo",
    onbManusFeat2Title: "AI výzvy pro přepis",
    onbManusFeat2Desc: "Extrakce textu, úprava a formátování jedním kliknutím",
    onbManusFeat3Title: "Offline kontrola pravopisu",
    onbManusFeat3Desc: "Souběžná kontrola indonéštiny, arabštiny a angličtiny",
    onbManusFeat4Title: "Formát projektu .manus",
    onbManusFeat4Desc: "PDF i dokument propojené v jednom projektu",
onbTitle2: 'Toto je jen začátek',
    onbBody2:
      'Manuscriber je stále ve fázi alfa. Připojte se ke skupinovému chatu na GenTeam, sdílejte zpětnou vazbu a pomozte utvářet, co přijde dál.',
  ...
  nl: {
    ...
    openWithManuscriber: 'Openen met Manuscriber',
    ...
    intgHeroTitle: 'Manuscriber gebruiken vanuit uw AI-assistent',
    intgHeroDesc:
      'Installeer de Manuscriber-skill één keer, en Claude Code, Codex, Cursor en vergelijkbare assistenten kunnen Word-, Excel-, PowerPoint-, PDF- en Markdown-bestanden voor u maken, converteren, lezen en bewerken. Alles draait op deze computer; er wordt niets geüpload.',
    ...
    intgStep1Update:
      'Wanneer een Manuscriber-update een nieuwere skill meebrengt, verschijnt naast die assistent een knop Bijwerken.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Kies zijn skills-map en Manuscriber schrijft het bestand daar.',
    ...
    intgExample3: 'Zet budget.xlsx om naar PDF en open het in Manuscriber',
    intgStep2Note:
    ...
    intgCliEphemeral: "Sleep Manuscriber eerst naar Programma's en gebruik daarna de opdrachtregel.",
    intgCopyPath: 'Pad kopiëren',
    intgCliNeedsUpdate: 'Deze skill vereist opdrachtregel {v} of nieuwer; werk Manuscriber bij.',
    ...
    starPromptTitle: 'Bevalt Manuscriber?',
    starPromptTitleN: 'Je hebt al {n} documenten geopend met Manuscriber',
    starPromptBody:
      'Manuscriber is gratis en open source. Een ster op GitHub is de beste steun voor het team.',
    starPromptGo: 'Geef een ster',
    starPromptDone: 'Al gedaan',
    starPromptLater: 'Later',
    onbStarHint: 'Als Manuscriber je bevalt, geef ons dan een ster op GitHub.',
    setEmail: 'E-mail',
    ...
    // First-run onboarding
    onbTitle1: 'Welkom bij Manuscriber',
    ...
    onbBody1:
      'Maak documenten, bouw spreadsheets, maak presentaties en beoordeel PDF-bestanden. AI zit in elke stap ingebouwd.',
        onbTitleManus: "Nieuwe functie: Manuscript-transcriber",
    onbSubtitleManus: "Gesplitste weergave om manuscripten en PDF direct naar Word-documenten te transcriberen",
    onbBodyManus: "Met speciale transcriptieworkflow, slimme AI-prompts, offline spellingcontrole in 3 talen en .manus-projectindeling.",
    onbManusFeat1Title: "Gesplitste werkruimte",
    onbManusFeat1Desc: "Lees de originele PDF links, transcribeer in Word rechts",
    onbManusFeat2Title: "AI-transcriptieprompts",
    onbManusFeat2Desc: "Tekstextractie, correctie en opmaak in één klik",
    onbManusFeat3Title: "Offline spelling in 3 talen",
    onbManusFeat3Desc: "Gelijktijdige controle van Indonesisch, Arabisch en Engels",
    onbManusFeat4Title: ".manus-projectindeling",
    onbManusFeat4Desc: "PDF en document gesynchroniseerd in één project",
onbTitle2: 'Dit is nog maar het begin',
    onbBody2:
      'Manuscriber is nog in alfa. Doe mee aan de groepschat op GenTeam om feedback te delen en mee te bepalen wat er komt.',
  ...
  ms: {
    ...
    setSecAbout: 'Perihal',
    setSecIntegrations: 'Integrasi',
    intgHeroTitle: 'Gunakan Manuscriber daripada pembantu AI anda',
    intgHeroDesc:
      'Pasang skill Manuscriber sekali, dan Claude Code, Codex, Cursor serta pembantu seumpamanya boleh mencipta, menukar, membaca dan menyunting fail Word, Excel, PowerPoint, PDF dan Markdown untuk anda. Semuanya berjalan pada komputer ini; tiada apa-apa yang dimuat naik.',
    ...
    intgStep1Update:
      'Apabila kemas kini Manuscriber membawa skill yang lebih baharu, butang Kemas kini muncul di sebelah pembantu itu.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'Pilih folder skills pembantu itu dan Manuscriber menulis fail di sana.',
    ...
    intgExample3: 'Tukar budget.xlsx kepada PDF dan buka dalam Manuscriber',
    intgStep2Note:
    ...
    intgSavedTo: 'Disimpan ke {path}',
    intgCopied: 'Disalin',
    intgCliEphemeral: 'Seret Manuscriber ke Applications dahulu, kemudian gunakan baris arahan.',
    intgCopyPath: 'Salin laluan',
    intgCliNeedsUpdate:
      'Skill ini memerlukan baris arahan {v} atau lebih baharu; kemas kini Manuscriber.',
    ...
    starPromptTitleN: 'Anda telah membuka {n} dokumen dengan Manuscriber',
    starPromptBody:
      'Manuscriber percuma dan sumber terbuka. Bintang di GitHub ialah sokongan terbaik untuk pasukan kami.',
    starPromptGo: 'Beri Bintang',
    starPromptDone: 'Sudah',
    starPromptLater: 'Kemudian',
    onbStarHint: 'Jika anda suka Manuscriber, beri kami bintang di GitHub.',
    setEmail: 'E-mel',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke Manuscriber',
    ...
    onbBody1:
      'Cipta dokumen, bina hamparan, hasilkan persembahan dan semak PDF. AI tersedia pada setiap langkah.',
        onbTitleManus: "Ciri Baharu: Manuscriber (Transkripsi Manuskrip & PDF)",
    onbSubtitleManus: "Paparan split-screen untuk menyalin manuskrip dan dokumen PDF terus ke Word",
    onbBodyManus: "Dilengkapi pemapar PDF terbina dalam, pintasan prompt AI pintar, semakan ejaan 3 bahasa luar talian, dan format projek .manus.",
    onbManusFeat1Title: "Ruang Kerja Skrin Pisah",
    onbManusFeat1Desc: "Baca PDF naskhah di sebelah kiri, taip transkrip di Word di sebelah kanan",
    onbManusFeat2Title: "Pintasan Prompt AI Transkripsi",
    onbManusFeat2Desc: "Ekstrak teks, semakan ejaan kuno dan pemformatan sepintas lalu",
    onbManusFeat3Title: "Semakan Ejaan 3 Bahasa Luar Talian",
    onbManusFeat3Desc: "Pemeriksaan serentak untuk Bahasa Indonesia, Arab dan Inggeris",
    onbManusFeat4Title: "Format Projek .manus",
    onbManusFeat4Desc: "Simpan PDF dan dokumen kerja terselaras dalam satu fail",
onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'Manuscriber masih dalam peringkat alfa. Sertai sembang kumpulan di GenTeam untuk berkongsi maklum balas dan membentuk masa depannya.',
  ...
  he: {
    ...
    openWithManuscriber: 'פתח באמצעות Manuscriber',
    copyPath: 'העתקת נתיב',
    ...
    intgHeroTitle: 'שימוש ב-Manuscriber מתוך עוזר ה-AI שלכם',
    intgHeroDesc:
      'התקינו את ה-skill של Manuscriber פעם אחת, ו-Claude Code, Codex, Cursor ועוזרים דומים יוכלו ליצור, להמיר, לקרוא ולערוך עבורכם קובצי Word, Excel, PowerPoint, PDF ו-Markdown. הכול רץ על המחשב הזה; דבר אינו מועלה.',
    ...
    intgStep1Update: 'כשעדכון של Manuscriber מביא skill חדש יותר, ליד אותו עוזר יופיע כפתור עדכון.',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'בחרו את תיקיית ה-skills שלו ו-Manuscriber יכתוב שם את הקובץ.',
    ...
    intgExample3: 'המר את budget.xlsx ל-PDF ופתח אותו ב-Manuscriber',
    ...
    intgCopied: 'הועתק',
    intgCliEphemeral: 'גררו קודם את Manuscriber לתיקיית היישומים, ואז השתמשו בשורת הפקודה.',
    intgCopyPath: 'העתקת נתיב',
    intgCliNeedsUpdate: 'skill זה דורש שורת פקודה {v} ומעלה; עדכנו את Manuscriber.',
    intgLoading: 'בודק…',
    ...
    starPromptTitle: 'נהנים מ-Manuscriber?',
    starPromptTitleN: 'פתחת {n} מסמכים עם Manuscriber',
    starPromptBody: 'Manuscriber חינמי ובקוד פתוח. כוכב ב-GitHub הוא התמיכה הטובה ביותר בצוות.',
    starPromptGo: 'לתת כוכב',
    starPromptDone: 'כבר נתתי',
    starPromptLater: 'אחר כך',
    onbStarHint: 'אם Manuscriber מוצא חן בעיניכם, תנו לנו כוכב ב-GitHub.',
    setEmail: 'אימייל',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-Manuscriber',
    ...
    onbBody1: 'צרו מסמכים, בנו גיליונות, הכינו מצגות ובדקו קובצי PDF. ה-AI מובנה בכל שלב.',
        onbTitleManus: "תכונה חדשה: מתמלל כתבי יד (Manuscriber)",
    onbSubtitleManus: "תצוגת מסך מפוצל לתמלול כתבי יד ומסמכי PDF ישירות לתוך Word",
    onbBodyManus: "כולל סביבת עבודה ייעודית לתמלול, הנחיות AI מותאמות, בדיקת איות לא מקוונת ב-3 שפות ופורמט פרויקט .manus.",
    onbManusFeat1Title: "סביבת עבודה במסך מפוצל",
    onbManusFeat1Desc: "קריאת ה-PDF המקורי משמאל, תמלול ב-Word מימין",
    onbManusFeat2Title: "הנחיות AI לתמלול",
    onbManusFeat2Desc: "חילוץ טקסט, הגהה ועיצוב בלחיצה אחת",
    onbManusFeat3Title: "בדיקת איות לא מקוונת ב-3 שפות",
    onbManusFeat3Desc: "בדיקה בו-זמנית לאינדונזית, ערבית ואנגלית",
    onbManusFeat4Title: "פורמט פרויקט .manus",
    onbManusFeat4Desc: "שמירת ה-PDF והמסמך מסונכרנים בפרויקט יחיד",
onbTitle2: 'זו רק ההתחלה',
    onbBody2:
      'Manuscriber עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-GenTeam כדי לשתף משוב ולעזור לעצב את ההמשך.',
  ...
  hi: {
    ...
    openWithManuscriber: 'Manuscriber के साथ खोलें',
    ...
    intgHeroTitle: 'अपने AI असिस्टेंट से Manuscriber इस्तेमाल करें',
    intgHeroDesc:
      'Manuscriber skill एक बार इंस्टॉल करें, फिर Claude Code, Codex, Cursor और ऐसे असिस्टेंट आपके लिए Word, Excel, PowerPoint, PDF और Markdown फ़ाइलें बना, बदल, पढ़ और संपादित कर सकेंगे। सब कुछ इसी कंप्यूटर पर चलता है; कुछ भी अपलोड नहीं होता।',
    ...
    intgStep1Update:
      'जब Manuscriber के अपडेट में नया skill आता है, तो उस असिस्टेंट के पास अपडेट बटन दिखता है।',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: 'उसका skills फ़ोल्डर चुनें, Manuscriber वहाँ फ़ाइल लिख देगा।',
    ...
    intgExample3: 'budget.xlsx को PDF में बदलो और Manuscriber में खोलो',
    ...
    intgCliEphemeral: 'पहले Manuscriber को Applications में खींचें, फिर कमांड लाइन का उपयोग करें।',
    intgCopyPath: 'पथ कॉपी करें',
    intgCliNeedsUpdate: 'इस skill को कमांड लाइन {v} या नया चाहिए; Manuscriber अपडेट करें।',
    ...
    starPromptTitle: 'Manuscriber पसंद आ रहा है?',
    starPromptTitleN: 'आपने Manuscriber में {n} दस्तावेज़ खोले हैं',
    starPromptBody:
      'Manuscriber मुफ़्त और ओपन सोर्स है। GitHub पर एक स्टार टीम का सबसे अच्छा समर्थन है।',
    starPromptGo: 'स्टार दें',
    starPromptDone: 'पहले ही दे दिया',
    starPromptLater: 'बाद में',
    onbStarHint: 'अगर आपको Manuscriber पसंद है, तो हमें GitHub पर स्टार दें।',
    setEmail: 'ईमेल',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'Manuscriber में आपका स्वागत है',
    ...
    onbBody1:
      'दस्तावेज़ बनाएँ, स्प्रेडशीट तैयार करें, प्रस्तुतियाँ बनाएँ और PDF की समीक्षा करें। AI हर चरण में शामिल है।',
        onbTitleManus: "नई सुविधा: पांडुलिपि प्रतिलेखक (Manuscriber)",
    onbSubtitleManus: "पांडुलिपियों और पीडीएफ को सीधे वर्ड में ट्रांसक्राइब करने के लिए स्प्लिट-स्क्रीन दृश्य",
    onbBodyManus: "विशेष ट्रांसक्रिप्शन वर्कफ़्लो, स्मार्ट एआई संकेत, ऑफ़लाइन 3-भाषा वर्तनी जाँच और .manus प्रोजेक्ट प्रारूप से लैस।",
    onbManusFeat1Title: "स्प्लिट-स्क्रीन कार्यक्षेत्र",
    onbManusFeat1Desc: "बाईं ओर मूल पीडीएफ पढ़ें, दाईं ओर वर्ड में ट्रांसक्राइब करें",
    onbManusFeat2Title: "एआई ट्रांसक्रिप्शन संकेत",
    onbManusFeat2Desc: "एक क्लिक में टेक्स्ट निष्कर्षण, सुधार और प्रारूपण",
    onbManusFeat3Title: "ऑफ़लाइन 3-भाषा वर्तनी जाँच",
    onbManusFeat3Desc: "इंडोनेशियाई, अरबी और अंग्रेजी की एक साथ जाँच",
    onbManusFeat4Title: ".manus प्रोजेक्ट प्रारूप",
    onbManusFeat4Desc: "पीडीएफ और दस्तावेज़ को एक ही प्रोजेक्ट में सिंक रखें",
onbTitle2: 'यह तो बस शुरुआत है',
    onbBody2:
      'Manuscriber अभी अल्फ़ा में है। GenTeam पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
  ...
  'zh-TW': {
    ...
    openWithManuscriber: '用 Manuscriber 開啟',
    copyPath: '複製路徑',
    moveToProject: '移至專案',
    rename: '重新命名',
    duplicate: '建立副本',
    ...
    intgHeroTitle: '在 AI 助理中使用 Manuscriber',
    intgHeroDesc:
      '安裝一次 Manuscriber skill，Claude Code、Codex、Cursor 等助理就能替你建立、轉換、讀取與編輯 Word、Excel、PowerPoint、PDF 和 Markdown 檔案。全部在本機完成，不會上傳任何內容。',
    ...
    intgStep1Update: 'Manuscriber 升級帶來新版 skill 時，對應助理旁會出現「更新」按鈕。',
    intgSkillVersion: 'skill {v}',
    ...
    intgOtherFolderDesc: '選擇它的 skills 資料夾，Manuscriber 會把檔案寫進去。',
    ...
    intgExample3: '把 budget.xlsx 轉成 PDF，並在 Manuscriber 中開啟',
    ...
    intgCopied: '已複製',
    intgCliEphemeral: '請先把 Manuscriber 拖到「應用程式」，再使用命令列。',
    intgCopyPath: '複製路徑',
    intgCliNeedsUpdate: '此 skill 需要命令列 {v} 或更新版本，請更新 Manuscriber。',
    intgLoading: '正在檢查…',
    intgUpdateDue: 'skill 有新版本可更新',
    setSecAiModel: 'AI 模型',
    setAiProvider: '模型服務商',
    ...
    starPromptTitle: '喜歡 Manuscriber 嗎？',
    starPromptTitleN: '你已經用 Manuscriber 開啟了 {n} 個文件',
    starPromptBody: 'Manuscriber 是免費的開源軟體。到 GitHub 給我們一顆星，是對團隊最好的支持。',
    starPromptGo: '去給星星',
    starPromptDone: '已經給過了',
    starPromptLater: '以後再說',
    onbStarHint: '如果你喜歡 Manuscriber，歡迎到 GitHub 給我們一顆星。',
    setEmail: '電子郵件',
    setNotLoggedIn: '未登入',
    setViewUsage: '查看用量',
    setChange: '變更',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 Manuscriber',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
        onbTitleManus: "全新功能：手稿轉錄器（Manuscriber）",
    onbSubtitleManus: "雙欄分屏檢視，邊查看 PDF / 歷史古籍手稿邊轉錄為 Word 文件",
    onbBodyManus: "配備專業轉錄工作流程、智慧 AI 提示詞庫、多語言離線拼字檢查與 .manus 專案格式。",
    onbManusFeat1Title: "分屏對照檢視",
    onbManusFeat1Desc: "左側瀏覽 PDF 原稿，右側即時編輯 Word 文件",
    onbManusFeat2Title: "專用 AI 提示詞",
    onbManusFeat2Desc: "一鍵提取文字、古籍潤色與排版整理",
    onbManusFeat3Title: "三語離線拼字檢查",
    onbManusFeat3Desc: "印尼語、阿拉伯語、英語多語言自動校對",
    onbManusFeat4Title: ".manus 專案儲存",
    onbManusFeat4Desc: "手稿與文件完整打包，隨時隨地恢復工作",
onbTitle2: '這只是一個開始',
    onbBody2: 'Manuscriber 目前仍在 alpha 階段。歡迎加入 GenTeam 群聊，分享回饋，一起打造它的未來。',
