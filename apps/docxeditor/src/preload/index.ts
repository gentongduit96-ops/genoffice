...
const api: DesktopApi = {
  ...
  pickPdf: () => ipcRenderer.invoke('manuscriber:pick-pdf'),
  saveManusProjectAs: (defaultName: string, data: ArrayBuffer, sourcePath?: string | null) =>
...
// Note: installDropOpenBridge is omitted so dropped PDFs are handled directly within Manuscriber
