...
export const zoteroStrings = defineStrings({
  zh: {
    ...
    zoteroNoteFieldsUnsupported:
      '此文档的脚注或尾注中含有 Zotero 引文，Manuscriber 目前还不能更新它们。为保持参考文献表完整，已停用此文档的 Zotero 命令。',
    zoteroGroup: 'Zotero',
  },
  en: {
    ...
    zoteroNoteFieldsUnsupported:
      'This document has Zotero citations in footnotes or endnotes, which Manuscriber cannot update yet. Zotero commands are turned off here so the bibliography stays intact.',
    zoteroGroup: 'Zotero',
  },
  ja: {
    ...
    zoteroNoteFieldsUnsupported:
      'この文書の脚注または文末脚注に Zotero の引用が含まれていますが、Manuscriber はまだ更新できません。参考文献一覧を保つため、この文書では Zotero コマンドを無効にしています。',
    zoteroGroup: 'Zotero',
  },
  ko: {
    ...
    zoteroNoteFieldsUnsupported:
      '이 문서의 각주 또는 미주에 Zotero 인용이 있으며 Manuscriber는 아직 이를 업데이트할 수 없습니다. 참고문헌을 그대로 유지하기 위해 이 문서에서는 Zotero 명령이 비활성화되었습니다.',
    zoteroGroup: 'Zotero',
  },
  fr: {
    ...
    zoteroNoteFieldsUnsupported:
      'Ce document contient des citations Zotero dans les notes de bas de page ou de fin, que Manuscriber ne peut pas encore mettre à jour. Les commandes Zotero sont désactivées ici afin de préserver la bibliographie.',
    zoteroGroup: 'Zotero',
  },
  de: {
    ...
    zoteroNoteFieldsUnsupported:
      'Dieses Dokument enthält Zotero-Zitate in Fuß- oder Endnoten, die Manuscriber noch nicht aktualisieren kann. Die Zotero-Befehle sind hier deaktiviert, damit das Literaturverzeichnis intakt bleibt.',
    zoteroGroup: 'Zotero',
  },
  es: {
    ...
    zoteroNoteFieldsUnsupported:
      'Este documento tiene citas de Zotero en notas al pie o al final que Manuscriber aún no puede actualizar. Los comandos de Zotero están desactivados aquí para mantener intacta la bibliografía.',
    zoteroGroup: 'Zotero',
  },
  th: {
    ...
    zoteroNoteFieldsUnsupported:
      'เอกสารนี้มีการอ้างอิง Zotero ในเชิงอรรถหรืออ้างอิงท้ายเรื่อง ซึ่ง Manuscriber ยังอัปเดตไม่ได้ คำสั่ง Zotero จึงถูกปิดไว้เพื่อรักษาบรรณานุกรมให้ครบถ้วน',
    zoteroGroup: 'Zotero',
  },
  id: {
    ...
    zoteroNoteFieldsUnsupported:
      'Dokumen ini memiliki sitasi Zotero di catatan kaki atau catatan akhir yang belum dapat diperbarui Manuscriber. Perintah Zotero dinonaktifkan di sini agar daftar pustaka tetap utuh.',
    zoteroGroup: 'Zotero',
  },
  ru: {
    ...
    zoteroNoteFieldsUnsupported:
      'В сносках или концевых сносках этого документа есть цитаты Zotero, которые Manuscriber пока не может обновлять. Команды Zotero здесь отключены, чтобы библиография осталась целой.',
    zoteroGroup: 'Zotero',
  },
  ar: {
    ...
    zoteroNoteFieldsUnsupported:
      'يحتوي هذا المستند على استشهادات Zotero في الحواشي السفلية أو الختامية، ولا يستطيع Manuscriber تحديثها بعد. تم تعطيل أوامر Zotero هنا للحفاظ على قائمة المراجع سليمة.',
    zoteroGroup: 'Zotero',
  },
  pt: {
    ...
    zoteroNoteFieldsUnsupported:
      'Este documento tem citações do Zotero em notas de rodapé ou de fim que o Manuscriber ainda não consegue atualizar. Os comandos do Zotero estão desativados aqui para manter a bibliografia intacta.',
    zoteroGroup: 'Zotero',
  },
  it: {
    ...
    zoteroNoteFieldsUnsupported:
      'Questo documento contiene citazioni Zotero nelle note a piè di pagina o di chiusura, che Manuscriber non può ancora aggiornare. I comandi Zotero sono disattivati qui per mantenere intatta la bibliografia.',
    zoteroGroup: 'Zotero',
  },
  pl: {
    ...
    zoteroNoteFieldsUnsupported:
      'Ten dokument zawiera cytowania Zotero w przypisach dolnych lub końcowych, których Manuscriber nie potrafi jeszcze aktualizować. Polecenia Zotero są tu wyłączone, aby bibliografia pozostała nienaruszona.',
    zoteroGroup: 'Zotero',
  },
  cs: {
    ...
    zoteroNoteFieldsUnsupported:
      'Tento dokument obsahuje citace Zotero v poznámkách pod čarou nebo vysvětlivkách, které Manuscriber zatím neumí aktualizovat. Příkazy Zotero jsou zde vypnuté, aby bibliografie zůstala nedotčená.',
    zoteroGroup: 'Zotero',
  },
  nl: {
    ...
    zoteroNoteFieldsUnsupported:
      'Dit document bevat Zotero-citaties in voet- of eindnoten die Manuscriber nog niet kan bijwerken. Zotero-opdrachten zijn hier uitgeschakeld zodat de bibliografie intact blijft.',
    zoteroGroup: 'Zotero',
  },
  ms: {
    ...
    zoteroOperationError: 'Operasi Zotero gagal.',
    zoteroNoteFieldsUnsupported:
      'Dokumen ini mempunyai petikan Zotero dalam nota kaki atau nota hujung yang belum boleh dikemas kini oleh Manuscriber. Perintah Zotero dimatikan di sini supaya bibliografi kekal utuh.',
    zoteroGroup: 'Zotero',
  },
  he: {
    ...
    zoteroNoteFieldsUnsupported:
      'מסמך זה מכיל ציטוטים של Zotero בהערות שוליים או הערות סיום, ש-Manuscriber עדיין אינו יכול לעדכן. פקודות Zotero מושבתות כאן כדי לשמור על הביבליוגרפיה שלמה.',
    zoteroGroup: 'Zotero',
  },
  hi: {
    ...
    zoteroNoteFieldsUnsupported:
      'इस दस्तावेज़ के फ़ुटनोट या एंडनोट में Zotero उद्धरण हैं, जिन्हें Manuscriber अभी अपडेट नहीं कर सकता। ग्रंथसूची को सुरक्षित रखने के लिए यहाँ Zotero कमांड बंद हैं।',
    zoteroGroup: 'Zotero',
  },
  'zh-TW': {
    zoteroCitation: 'Zotero 引文',
    ...
    zoteroNoteFieldsUnsupported:
      '此文件的註腳或章節附註中含有 Zotero 引文，Manuscriber 目前還無法更新它們。為保持參考文獻完整，已停用此文件的 Zotero 命令。',
    zoteroGroup: 'Zotero',
  },
})
