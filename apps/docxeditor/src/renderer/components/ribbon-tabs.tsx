...
const TRANSLATE_TARGETS: Array<{ labelKey: StringKey }> = [
  { labelKey: 'ribbonLangIndonesian' },
  { labelKey: 'ribbonLangEnglish' },
  { labelKey: 'ribbonLangArabic' },
    ...
    <>
      ...
      <div className="ribbon-group">
        <div className="ribbon-group-items">
          ...
          <button
            className="rb-big"
            disabled={!hasDoc || (isProtected && !commentsAllowed)}
            data-tip={t('ribbonPageAnalyzeTip') || 'Analisis teks per halaman dan sematkan komentar / usulan revisi otomatis'}
            onClick={onPageAnalysis}
          >
            <span className="rb-big-icon">
              <span className="ai-feature-icon" aria-hidden="true">
                <svg
                ...
                >
                  ...
                  <path d="M14 2v6h6" />
                  <path d="M16 13l.2.5c.2.6.4 1 .7 1.3.3.3.7.5 1.3.7l.5.2-.5.2c-.6.2-1 .4-1.3.7-.3.3-.5.7-.7 1.3l-.2.5-.2-.5c-.2-.6-.4-1-.7-1.3-.3-.3-.7-.5-1.3-.7l-.5-.2.5-.2c.6-.2 1-.4 1.3-.7.3-.3.5-.7.7-1.3l.2-.5z" />
                </svg>
              </span>
            </span>
            <span>{t('ribbonPageAnalyze') || 'Analisis Halaman AI'}</span>
          </button>
        </div>
