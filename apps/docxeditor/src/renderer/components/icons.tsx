...
/* ── Fluent 2 Icons for Manuscriber & Document Tools ── */

export function IconDocumentPdf(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M3.5 2.5h6l3 3v8a1 1 0 01-1 1h-8a1 1 0 01-1-1v-10a1 1 0 011-1z" />
      <path d="M9.5 2.5v3h3" />
      <path d="M5.5 8.5h5M5.5 11.5h3.5" />
    </Svg>
  )
}

export function IconManuscript(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M3 3.5a1.5 1.5 0 011.5-1.5h7a1.5 1.5 0 011.5 1.5v8a1.5 1.5 0 01-1.5 1.5h-7A1.5 1.5 0 013 11.5v-8z" />
...
export function IconFlash(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M8.5 1.5L3.5 9h4.5l-1 5.5 6-7.5H8.5l1-5.5z" fill="currentColor" stroke="none" />
    </Svg>
  )
}
...
export function IconFolderOpen(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M2 4a1 1 0 011-1h3.5l1.5 1.5H13a1 1 0 011 1v1.5H3a1 1 0 00-.96.73L1 12.5V4z" />
      <path d="M2.04 7.23A1 1 0 013 6.5h11a1 1 0 01.96 1.27l-1.5 5A1 1 0 0112.5 13.5h-10a1 1 0 01-.96-1.27l1.5-5z" />
    </Svg>
  )
}

export function IconDocumentBulletList(props: IconProps) {
  return (
    <Svg {...props}>
...
export function IconSettings(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M7 1.8h2l.4 1.4a4.8 4.8 0 0 1 1.2.5l1.2-.8 1.4 1.4-.8 1.2a4.8 4.8 0 0 1 .5 1.2l1.4.4v2l-1.4.4a4.8 4.8 0 0 1-.5 1.2l.8 1.2-1.4 1.4-1.2-.8a4.8 4.8 0 0 1-1.2.5l-.4 1.4H7l-.4-1.4a4.8 4.8 0 0 1-1.2-.5l-1.2.8-1.4-1.4.8-1.2a4.8 4.8 0 0 1-.5-1.2l-1.4-.4v-2l1.4-.4a4.8 4.8 0 0 1 .5-1.2l-.8-1.2 1.4-1.4 1.2.8a4.8 4.8 0 0 1 1.2-.5z" />
    </Svg>
  )
}
...
export function IconLightbulb(props: IconProps) {
  return (
    <Svg {...props}>
      <path d="M5.5 6a2.5 2.5 0 015 0c0 1.5-1 2.5-1 3.5h-3c0-1-1-2-1-3.5zM6.5 11.5h3M7 13.5h2" />
    </Svg>
  )
}
...
export function IconFitPage(props: IconProps) {
  return (
    <Svg {...props}>
      ...
      <path d="M1.5 5.5V2.5h3M14.5 5.5V2.5h-3M1.5 10.5v3h3M14.5 10.5v3h-3" />
    </Svg>
  )
}
